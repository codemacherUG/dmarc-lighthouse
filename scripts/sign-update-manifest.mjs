...
console.log('')
console.log(`Deploy to: https://codemacher.de/dmarc-lighthouse/updates/${basename(jsonPath)}`)
console.log(`       and: https://codemacher.de/dmarc-lighthouse/updates/${basename(sigPath)}`)
