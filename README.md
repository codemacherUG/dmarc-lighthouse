...
| **Mailbox noise filter**  | Optional, persisted filter that hides forwarding / report-echo from Gmail, Outlook, Yahoo, iCloud **and Check Point Harmony** (`cloud-sec-av.com`; Harmony is omitted from problem sources even with the filter off)           |
