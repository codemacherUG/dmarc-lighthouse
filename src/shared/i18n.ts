...
const de = {
  ...
  'header.openFilesTitle': 'Lokale DMARC-Dateien importieren',
  ...
  'table.msgs': 'Msgs',
  'table.passPct': 'Pass %',
  'table.delivered': 'Zugestellt',
  'table.ipSender': 'Quell-IP',
  'table.domain': 'Domain',
  ...
  'settings.dnssec': 'DNSSEC-Prüfung',
  'settings.dnssecEnabled': 'DNSSEC-Prüfung beim DNS-Check ausführen',
  'settings.dnssecResolver': 'Validierender Resolver',
  'settings.dnssecResolverQuad9': 'Quad9 (Standard)',
  'settings.dnssecResolverCloudflare': 'Cloudflare',
  'settings.dnssecResolverCustom': 'Eigene DoH-URL',
  'settings.dnssecResolverUrl': 'DoH-URL',
  'settings.dnssecHint':
    'Die DNSSEC-Prüfung benötigt einen validierenden DNS-over-HTTPS-Resolver. Eigene URLs müssen RFC 8484 unterstützen. Die übrigen DNS-Records werden weiterhin direkt beim autoritativen Nameserver abgefragt.',
  ...
  'newSources.title': 'Neue Quell-IPs',
  'newSources.info':
    'Eine neue Quell-IP ist nicht automatisch ein neuer Versanddienst. Anbieter und From-Domain helfen bei der Einordnung; PTR und IP allein belegen keinen Versanddienst. „Bekannt“ speichert einen bestätigten Versandweg für die From-Domain. „Prüfen“ hält den Fund offen. „Stillgelegt“ warnt bewusst weiter, falls der Versandweg erneut auftaucht.',
  'newSources.hint':
    'Nur einen bestätigten Anbieter als Versandweg speichern. Normale Infrastrukturwechsel kannst du als gesehen markieren. Rauschen nur für typische Scanner- oder Weiterleitungsfälle markieren.',
  'newSources.empty': 'Keine neuen Quell-IPs zur Prüfung.',
  'newSources.markKnown': 'Versandweg als bekannt speichern',
  'newSources.marked': 'Versandweg als bekannt gespeichert — künftig kein Alert mehr dafür.',
  'newSources.applyStatus': 'Versandweg speichern',
  ...
  'newSources.itemWithDomain': 'Neue IPs bei {provider} für {domain}',
  'newSources.itemNoDomain': 'Neue IPs bei {provider} (unbekannte Domain)',
  'newSources.unknownProvider': 'unbekanntem Netz',
  ...
  'newSources.dialogHint':
    '{count} erstmals beobachtete Quell-IP(s). Metadaten prüfen, als gesehen markieren oder nur bei einem bestätigten Anbieter einen Versandweg anlegen.',
  ...
  'newSources.noService': 'Als gesehen markieren',
  'newSources.ipRemoved': 'IP als gesehen markiert.',
  'newSources.selectAll': 'Alle auswählen',
  'newSources.selectIp': 'IP {ip} auswählen',
  'newSources.selectedCount': '{count} ausgewählt',
  'newSources.addSelectedService': 'Versandweg anlegen ({count})',
  'newSources.addService': 'Versandweg anlegen …',
  'newSources.acknowledge': 'Bestätigen',
  'newSources.deleteGroup': 'Als gesehen markieren',
  'newSources.groupDeleted': 'Quell-IPs als gesehen markiert.',
  'newSources.notePrefillIps':
    'Bisher gesehene Quell-IPs: {ips}. Nicht als feste IP- oder CIDR-Bindung gespeichert.',
  ...
  'dns.dnssecValidated': 'DNSSEC: validiert ({resolver})',
  'dns.dnssecUnsigned': 'DNSSEC: nicht signiert ({resolver})',
  'dns.dnssecError': 'DNSSEC: nicht prüfbar ({message})',
  ...
  'main.alertNewSendingSource': 'Neue Quell-IP erkannt: {shown}{more}{suffix}.',
  'main.alertUnknownProvider': 'unbekanntes Netz',
  'main.alertSendingSourceItem': 'IP bei {provider} für {domain}',
  'main.alertSendingSourceItemNoDomain': 'IP bei {provider} (unbekannte Domain)',
...
const en: Dict = {
  ...
  'header.openFilesTitle': 'Import local DMARC files',
  ...
  'settings.dnssec': 'DNSSEC check',
  'settings.dnssecEnabled': 'Run DNSSEC validation in the DNS check',
  'settings.dnssecResolver': 'Validating resolver',
  'settings.dnssecResolverQuad9': 'Quad9 (default)',
  'settings.dnssecResolverCloudflare': 'Cloudflare',
  'settings.dnssecResolverCustom': 'Custom DoH URL',
  'settings.dnssecResolverUrl': 'DoH URL',
  'settings.dnssecHint':
    'The DNSSEC check requires a validating DNS-over-HTTPS resolver. Custom URLs must support RFC 8484. Other DNS records continue to be queried directly at the authoritative nameserver.',
  ...
  'newSources.title': 'New source IPs',
  'newSources.info':
    'A new source IP is not automatically a new sending service. Provider and From domain help classify it; a PTR or IP alone does not prove a sending service. “Known” saves a confirmed sending service for the From domain. “Investigate” keeps the finding open. “Retired” deliberately continues to warn if the sending service appears again.',
  'newSources.hint':
    'Only save a confirmed provider as a sending service. Mark ordinary infrastructure changes as seen. Mark noise only for typical scanner or forwarding cases.',
  'newSources.empty': 'No new source IPs to review.',
  'newSources.markKnown': 'Save known sending service',
  'newSources.marked': 'Known sending service saved — no more alerts for this combination.',
  'newSources.applyStatus': 'Save sending service',
  ...
  'newSources.itemWithDomain': 'New IPs at {provider} for {domain}',
  'newSources.itemNoDomain': 'New IPs at {provider} (unknown domain)',
  'newSources.unknownProvider': 'an unknown network',
  'newSources.ipCount': '{count} IP(s)',
  'newSources.reviewIp': 'Review {count} IP',
  'newSources.reviewIps': 'Review {count} IPs',
  'newSources.dialogHint':
    '{count} source IP(s) observed for the first time. Review metadata, mark as seen, or create a sending service only for a confirmed provider.',
  'newSources.ipDetails': 'Details',
  ...
  'newSources.noService': 'Mark as seen',
  'newSources.ipRemoved': 'IP marked as seen.',
  'newSources.selectAll': 'Select all',
  'newSources.selectIp': 'Select IP {ip}',
  'newSources.selectedCount': '{count} selected',
  'newSources.addSelectedService': 'Create sending service ({count})',
  'newSources.addService': 'Create sending service…',
  'newSources.acknowledge': 'Acknowledge',
  'newSources.deleteGroup': 'Mark as seen',
  'newSources.groupDeleted': 'Source IPs marked as seen.',
  'newSources.notePrefillIps':
    'Source IPs seen so far: {ips}. They are not saved as a fixed IP or CIDR binding.',
  ...
  'dns.dnssecValidated': 'DNSSEC: validated ({resolver})',
  'dns.dnssecUnsigned': 'DNSSEC: unsigned ({resolver})',
  'dns.dnssecError': 'DNSSEC: unable to check ({message})',
  ...
  'main.alertNewSendingSource': 'New source IP detected: {shown}{more}{suffix}.',
  'main.alertUnknownProvider': 'unknown network',
  'main.alertSendingSourceItem': 'IP at {provider} for {domain}',
  'main.alertSendingSourceItemNoDomain': 'IP at {provider} (unknown domain)',
