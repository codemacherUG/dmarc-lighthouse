...
const de = {
  ...
  'about.description':
    'Desktop-Tool zum Abrufen und Analysieren von DMARC-Aggregate-Reports aus einem IMAP-Postfach oder lokalen Dateien.',
...
const en: Dict = {
  ...
  'about.version': 'Version',
  'about.description':
    'Desktop tool for fetching and analyzing DMARC aggregate reports from an IMAP mailbox or local files.',
  'about.copyright': 'Copyright',
  'about.website': 'Website',
  'about.email': 'Email',
